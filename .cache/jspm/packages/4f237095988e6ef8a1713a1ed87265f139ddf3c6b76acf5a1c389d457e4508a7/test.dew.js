...
import { dew as _isstreamDewDew } from "./isstream.dew.js";
...
export function dew() {
  ...
  var tape = _nodeRequire('tape'),
      ...
      util = _util,
      isStream = _isstreamDewDew(),
      isReadable = _isstreamDewDew().isReadable,
      isWritable = _isstreamDewDew().isWritable,
      isDuplex = _isstreamDewDew().isDuplex,
      CoreStreams = _stream,
      ReadableStream10 = _nodeRequire('./readable-stream-1.0/'),
      ReadableStream11 = _nodeRequire('./readable-stream-1.1/');

...
import { dew as _transformDewDew } from "readable-stream/transform.dew.js";
var exports = {},
    _dewExec = false;
export function dew() {
  ...
  var escapeRegExp = _indexDewDew();

  var objectAssign = _indexDew2Dew();

  var Transform = _transformDewDew();

  exports = function ReplaceStream(search, replace, options) {
    var tail = '';
    var totalMatches = 0;

...
import { dew as _seleniumDewDew } from "./selenium.dew.js";
var exports = {},
    _dewExec = false;
export function dew() {
  ...
  const browsers = _browsersDewDew();

  const selenium = _seleniumDewDew();
  ...
  const plugin = (wct, pluginOptions) => {
    ...
    let eachCapabilities = []; // Convert any local browser names into Webdriver capabilities objects.
    //
    ...
    const onConfigure = () => __awaiter(this, void 0, void 0, function* () {
      ...
      eachCapabilities = expanded; // We are careful to append these to the configuration object, even

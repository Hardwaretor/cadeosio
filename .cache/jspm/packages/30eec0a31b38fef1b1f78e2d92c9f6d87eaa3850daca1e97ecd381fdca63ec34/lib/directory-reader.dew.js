...
import { dew as _normalizeOptionsDewDew } from "./normalize-options.dew.js";
import { dew as _statDewDew } from "./stat.dew.js";
...
export function dew() {
  ...
  const normalizeOptions = _normalizeOptionsDewDew();

  const stat = _statDewDew();

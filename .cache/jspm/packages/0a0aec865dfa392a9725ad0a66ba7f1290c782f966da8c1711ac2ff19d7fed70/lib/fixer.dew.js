import { dew as _indexDewDew } from "semver/index.dew.js";
import { dew as _indexDew2Dew } from "validate-npm-package-license/index.dew.js";
import { dew as _indexDew3Dew } from "hosted-git-info/index.dew.js";
import { dew as _indexDew4Dew } from "resolve/index.dew.js";
import { dew as _extract_descriptionDewDew } from "./extract_description.dew.js";
import _url from "url";
import { dew as _typosJsonDewDew } from "./typos.json.dew.js";
var exports = {},
    _dewExec = false;
...
export function dew() {
  ...
  var semver = _indexDewDew();

  var validateLicense = _indexDew2Dew();

  var hostedGitInfo = _indexDew3Dew();

  var isBuiltinModule = _indexDew4Dew().isCore;

  var depTypes = ["dependencies", "devDependencies", "optionalDependencies"];

  var extractDescription = _extract_descriptionDewDew();

  var url = _url;

  var typos = _typosJsonDewDew();
  ...
  var fixer = exports = {
    ...
    fixDependencies: function (data, strict) {
      var loose = !strict;
      objectifyDeps(data, (this || _global).warn);
      addOptionalDepsToDeps(data, (this || _global).warn);
    ...
    fixBugsField: function (data) {
      if (!data.bugs && data.repository && data.repository.url) {
        ...
        if (typeof data.bugs == "string") {
          ...
          bugsTypos(data.bugs, (this || _global).warn);

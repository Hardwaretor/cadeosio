...
export function dew() {
  ...
  _dewExec = true;
  !function (t, n) {
    "object" == typeof exports && true ? n(exports) : "function" == typeof define && define.amd ? define(["exports"], n) : n(t.fecha = {});
  }(exports, function (t) {
    "use strict";
    ...
    var i = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"],
      ...
      return +t - 1;
        ...
        D = [null, "[1-9]\\d?"],
        Y = [null, e],
        p = ["isPm", e, function (t, n) {
      var e = t.toLowerCase();
      return e === n.amPm[0] ? 0 : e === n.amPm[1] ? 1 : null;
    }],
        y = ["timezoneOffset", "[^\\s]*?[\\+\\-]\\d\\d:?\\d\\d|[^\\s]*?Z?", function (t) {
      ...
      D: ["day", "[1-9]\\d?"],
      DD: ["day", "\\d\\d"],
      Do: ["day", "[1-9]\\d?" + e, function (t) {
        return parseInt(t, 10);
      }],
      M: ["month", "[1-9]\\d?", M],
      MM: ["month", "\\d\\d", M],
      YY: ["year", "\\d\\d", function (t) {
      ...
      return a(v, t);
        ...
        b = function (t, e, o) {
      if (void 0 === e && (e = v.default), void 0 === o && (o = {}), "number" == typeof t && (t = new Date(t)), "[object Date]" !== Object.prototype.toString.call(t) || isNaN(t.getTime())) throw new Error("Invalid Date pass to format");
      var u = [];
    ...
    function w(t, e, o) {
      ...
      1 === u.isPm && null != u.hour && 12 != +u.hour ? u.hour = +u.hour + 12 : 0 === u.isPm && 12 == +u.hour && (u.hour = 0);

      for (var H = new Date(u.year, u.month, u.day, u.hour, u.minute, u.second, u.millisecond), b = [["month", "getMonth"], ["day", "getDate"], ["hour", "getHours"], ["minute", "getMinutes"], ["second", "getSeconds"]], w = (M = 0, b.length); M < w; M++) if (f[b[M][0]] && u[b[M][0]] !== H[b[M][1]]()) return null;

      return null == u.timezoneOffset ? H : new Date(Date.UTC(u.year, u.month, u.day, u.hour, u.minute - u.timezoneOffset, u.second, u.millisecond));
    }
    ...
    t.assign = a, t.default = P, t.format = b, t.parse = w, t.defaultI18n = f, t.setGlobalDateI18n = c, t.setGlobalDateMasks = H, Object.defineProperty(t, "__esModule", {
      value: !0
    });
  });
  return exports;

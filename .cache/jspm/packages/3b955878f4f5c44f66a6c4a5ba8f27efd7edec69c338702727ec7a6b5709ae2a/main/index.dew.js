import { dew as _indexDewDew } from "chardet/index.dew.js";
import _child_process from "child_process";
import _fs from "fs";
import { dew as _indexDew2Dew } from "iconv-lite/index.dew.js";
import { dew as _indexDew3Dew } from "tmp/index.dew.js";
...
export function dew() {
  ...
  var chardet_1 = _indexDewDew();

  var child_process_1 = _child_process;
  var fs_1 = _fs;

  var iconv_lite_1 = _indexDew2Dew();

  var tmp_1 = _indexDew3Dew();

  var CreateFileError_1 = _CreateFileErrorDewDew();

  exports.CreateFileError = CreateFileError_1.CreateFileError;

  var LaunchEditorError_1 = _LaunchEditorErrorDewDew();

  exports.LaunchEditorError = LaunchEditorError_1.LaunchEditorError;

  var ReadFileError_1 = _ReadFileErrorDewDew();

  exports.ReadFileError = ReadFileError_1.ReadFileError;

  var RemoveFileError_1 = _RemoveFileErrorDewDew();

...
export function dew() {
  ...
  exports = function processOptions(options) {
    ...
    return _.reduce(_.omit(options, ["readyFileId", "verbose", "logger", "log", "connectRetries", "connectRetryTimeout", "downloadRetries", "downloadRetryTimeout", "detached", "connectVersion", "exe"]), function (argList, value, key) {

import { dew as _indexDewDew } from "dom-urls/index.dew.js";
var exports = {},
    _dewExec = false;
export function dew() {
  ...
  exports = {
    ...
    createCacheKey: function (originalUrl, paramName, paramValue, dontCacheBustUrlsMatching) {

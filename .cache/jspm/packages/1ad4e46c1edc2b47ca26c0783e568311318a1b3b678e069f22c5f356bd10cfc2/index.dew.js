...
import { dew as _indexDew2Dew } from "setprototypeof/index.dew.js";
import { dew as _indexDew3Dew } from "statuses/index.dew.js";
import { dew as _indexDew4Dew } from "inherits/index.dew.js";
import { dew as _indexDew5Dew } from "toidentifier/index.dew.js";
var exports = {},
    _dewExec = false;
export function dew() {
   ...
   * @private
   */
  var deprecate = _indexDewDew()('http-errors');

  var setPrototypeOf = _indexDew2Dew();

  var statuses = _indexDew3Dew();

  var inherits = _indexDew4Dew();

  var toIdentifier = _indexDew5Dew();
  /**
   * Module exports.
   * @public
   */
  ...
  exports = createError;
  exports.HttpError = createHttpErrorConstructor(); // Populate exports for all constructors

...
export function dew() {
  ...
  function Table(options) {
    (this || _global).options = utils.options({
      chars: {
        'top': '─',
        'top-mid': '┬',
        'top-left': '┌',
  ...
  Table.prototype.toString = function () {
    var ret = '',
        ...
        colWidths = options.colWidths || new Array((this || _global).head.length),
        totalWidth = 0;
    if (!head.length && !(this || _global).length) return '';
    ...
    if ((this || _global).length) this.forEach(function (cells, i) {

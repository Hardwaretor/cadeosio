import { dew as _exitDewDew } from "../tools/exit.dew.js";
import _fs from "fs";
import { dew as _packageJsonDewDew } from "../package.json.dew.js";
import _path from "path";
import { dew as _indexDewDew } from "commander/index.dew.js";
import { dew as _nodeDewDew } from "../tools/node.dew.js";
import { dew as _dompropsJsonDewDew } from "../tools/domprops.json.dew.js";
...
export function dew() {
  ...
  var program = _indexDewDew();

  var UglifyJS = _nodeDewDew();
  ...
  if (process.argv.indexOf("ast") >= 0) program.helpInformation = UglifyJS.describe_ast;else if (process.argv.indexOf("options") >= 0) program.helpInformation = function () {
    var text = [];
  ...
  ["compress", "enclose", "ie8", "mangle", "sourceMap", "toplevel", "wrap"].forEach(function (name) {
    if (name in program) {
  ...
  if (program.mangleProps) {
    if (program.mangleProps.domprops) {
      ...
      _dompropsJsonDewDew().forEach(function (name) {
      ...
      if (program.parse) {
        if (program.parse.acorn) {
          files = convert_ast(function (toplevel, name) {
            return _nodeRequire("acorn").parse(files[name], {
              locations: true,
              program: toplevel,
              sourceFile: name
            });

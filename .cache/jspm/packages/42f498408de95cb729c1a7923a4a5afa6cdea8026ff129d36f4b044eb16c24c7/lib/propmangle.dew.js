...
export function dew() {
  ...
  function find_builtins(reserved) {
    ...
    [Array, Boolean, Date, Error, Function, Math, Number, Object, RegExp, String].forEach(function (ctor) {
  ...
  function mangle_properties(ast, options) {
    ...
    var regex = options.regex; // note debug is either false (disabled), or a string of the debug suffix to use (enabled).

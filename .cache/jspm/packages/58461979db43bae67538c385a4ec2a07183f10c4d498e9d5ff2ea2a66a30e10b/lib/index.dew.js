...
export function dew() {
  ...
  var Url = _interopDefault(_url);

  var https = _interopDefault(_https);

  var zlib = _interopDefault(_zlib); // Based on https://github.com/tmpvar/jsdom/blob/aa85b2abf07766ff7bf5c1f6daafb3726f2f2db5/lib/jsdom/living/blob.js
  ...
  fetch.Promise = _global.Promise;
  exports = exports = fetch;
  Object.defineProperty(exports, "__esModule", {
    value: true
  });

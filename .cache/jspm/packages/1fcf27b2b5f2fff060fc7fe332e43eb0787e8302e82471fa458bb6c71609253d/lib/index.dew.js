import { dew as _charsetDewDew } from "./charset.dew.js";
import { dew as _scopeTrackerDewDew } from "./scope-tracker.dew.js";
import { dew as _isLabelIdentifierDewDew } from "./is-label-identifier.dew.js";
import { dew as _bfsTraverseDewDew } from "./bfs-traverse.dew.js";
import { dew as _fixupVarScopingDewDew } from "./fixup-var-scoping.dew.js";
import { dew as _indexDewDew } from "babel-helper-mark-eval-scopes/index.dew.js";
var exports = {},
    _dewExec = false;
export function dew() {
  ...
  const Charset = _charsetDewDew();

  const ScopeTracker = _scopeTrackerDewDew();

  const isLabelIdentifier = _isLabelIdentifierDewDew();

  const bfsTraverseCreator = _bfsTraverseDewDew();

  const fixupVarScoping = _fixupVarScopingDewDew();

  const _require = _indexDewDew(),

...
import { dew as _storeDewDew } from "./store.dew.js";
import { dew as _memstoreDewDew } from "./memstore.dew.js";
import { dew as _pathMatchDewDew } from "./pathMatch.dew.js";
import { dew as _packageJsonDewDew } from "../package.json.dew.js";
import _punycode from "punycode";
import { dew as _permuteDomainDewDew } from "./permuteDomain.dew.js";
var exports = {},
    _dewExec = false;
export function dew() {
  ...
  _dewExec = true;
  var net = _net;
  var urlParse = _url.parse;
  var util = _util;

  var pubsuffix = _pubsuffixPslDewDew();

  var Store = _storeDewDew().Store;

  var MemoryCookieStore = _memstoreDewDew().MemoryCookieStore;

  var pathMatch = _pathMatchDewDew().pathMatch;
  ...
  exports.permuteDomain = _permuteDomainDewDew().permuteDomain;

import { dew as _indexDewDew } from "to-buffer/index.dew.js";
import { dew as _indexDew2Dew } from "buffer-alloc/index.dew.js";
...
export function dew() {
  ...
  var toBuffer = _indexDewDew();

  var alloc = _indexDew2Dew();
  ...
  exports.decode = function (buf, filenameEncoding) {
    ...
    if (buf[345]) name = decodeStr(buf, 345, 155, filenameEncoding) + '/' + name; // to support old tar versions that use trailing / to indicate dirs

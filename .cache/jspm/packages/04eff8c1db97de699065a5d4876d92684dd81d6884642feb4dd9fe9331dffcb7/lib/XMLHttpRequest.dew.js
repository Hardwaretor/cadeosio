...
export function dew() {
  ...
  exports = XMLHttpRequest; // backwards-compat
  ...
  function XMLHttpRequest(opts) {
    ...
    var http = _http;
    var https = _https; // Holds http.js objects
    ...
    (this || _global).UNSENT = 0;
    (this || _global).OPENED = 1;
    (this || _global).HEADERS_RECEIVED = 2;
    (this || _global).LOADING = 3;
    (this || _global).DONE = 4;
    /**
     * Public vars
     */
    ...
    (this || _global).readyState = (this || _global).UNSENT; // default ready state change handler in case one is not set or is set late

    (this || _global).onreadystatechange = null; // Result & response

    (this || _global).responseText = "";
    (this || _global).responseXML = "";
    (this || _global).status = null;
    (this || _global).statusText = null;
    /**
     * Private methods
     */
    ...
    (this || _global).open = function (method, url, async, user, password) {
      this.abort();
    ...
    (this || _global).setDisableHeaderCheck = function (state) {
    ...
    (this || _global).setRequestHeader = function (header, value) {
      if ((this || _global).readyState != (this || _global).OPENED) {
    ...
    (this || _global).getResponseHeader = function (header) {
      if (typeof header === "string" && (this || _global).readyState > (this || _global).OPENED && response.headers[header.toLowerCase()] && !errorFlag) {
    ...
    (this || _global).getAllResponseHeaders = function () {
      if ((this || _global).readyState < (this || _global).HEADERS_RECEIVED || errorFlag) {
        return "";
      }
    ...
    (this || _global).getRequestHeader = function (name) {
    ...
    (this || _global).send = function (data) {
      if ((this || _global).readyState != (this || _global).OPENED) {
      ...
      if (local) {
        ...
        if (settings.async) {
          ...
          try {
            (this || _global).responseText = fs.readFileSync(url.pathname, 'utf8');
            (this || _global).status = 200;
            setState(self.DONE);
          } catch (e) {
            this.handleError(e);
          }
    ...
    (this || _global).handleError = function (error) {
      (this || _global).status = 503;
      (this || _global).statusText = error;
      (this || _global).responseText = error.stack;
      errorFlag = true;
      setState((this || _global).DONE);
    };
    /**
     * Aborts a request.
     */
    ...
    (this || _global).abort = function () {
      ...
      if ((this || _global).readyState !== (this || _global).UNSENT && ((this || _global).readyState !== (this || _global).OPENED || sendFlag) && (this || _global).readyState !== (this || _global).DONE) {
        sendFlag = false;
        setState((this || _global).DONE);
      }

      (this || _global).readyState = (this || _global).UNSENT;
    };
    /**
    ...
    (this || _global).addEventListener = function (event, callback) {
    ...
    (this || _global).removeEventListener = function (event, callback) {
      if (event in listeners) {
    ...
    (this || _global).dispatchEvent = function (event) {

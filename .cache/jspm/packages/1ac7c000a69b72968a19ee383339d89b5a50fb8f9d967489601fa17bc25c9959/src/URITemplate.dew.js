...
export function dew() {
  ...
  (function (root, factory) {
    ...
    function URITemplate(expression) {
      ...
      if (!((this || _global) instanceof URITemplate)) {
        return new URITemplate(expression);
      }

      (this || _global).expression = expression;
      URITemplate._cache[expression] = this || _global;
      return this || _global;
    }
    ...
    p.expand = function (data, opts) {
      ...
      if (!(this || _global).parts || !(this || _global).parts.length) {
      ...
      for (var i = 0, l = (this || _global).parts.length; i < l; i++) {
        /*jshint laxbreak: true */
        result += typeof (this || _global).parts[i] === 'string' // literal string
        ? (this || _global).parts[i] // expression
        : URITemplate.expand((this || _global).parts[i], data, opts);
    ...
    p.parse = function () {
      // performance crap
      var expression = (this || _global).expression;
    ...
    Data.prototype.get = function (key) {
      // performance crap
      var data = (this || _global).data; // cache for processed data-point
      ...
      if ((this || _global).cache[key] !== undefined) {
        // we've already processed this key
        return (this || _global).cache[key];
      }

      (this || _global).cache[key] = d;

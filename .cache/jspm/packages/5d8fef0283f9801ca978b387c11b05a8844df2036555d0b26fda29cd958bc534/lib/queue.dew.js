...
import { dew as _subqueueDewDew } from "./subqueue.dew.js";
var exports = {},
    _dewExec = false;
export function dew() {
  ...
  Queue.prototype.add = function (name, task, opt) {
    ...
    this.__queues__[name].push(task, opt); // don't run the tasks if `opt.run` is false

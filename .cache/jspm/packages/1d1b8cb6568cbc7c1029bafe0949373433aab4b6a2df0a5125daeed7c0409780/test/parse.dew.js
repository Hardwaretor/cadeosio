...
export function dew() {
  ...
  var iconv = _nodeRequire('iconv-lite');

  var SaferBuffer = _nodeRequire('safer-buffer').Buffer;
  ...
  test('parse()', function (t) {
    ...
    t.test('does not blow up when Buffer global is missing', function (st) {
      var tempBuffer = _global.Buffer;
      delete _global.Buffer;
      var result = qs.parse('a=b&c=d');
      _global.Buffer = tempBuffer;
      st.deepEqual(result, {
        a: 'b',
        c: 'd'
      });

    ...
    return function e(t, n, r) {
      ...
      1: [function (require, module, exports) {
        ...
        (function (scope) {
          ...
          var isNode = new Function('try {return this===global;}catch(e){return false;}'); // For Stacky-in-Node, we default to colored stacks.
          ...
          function pretty(stackOrParsed, options) {
            ...
            var parts = lines.map(function (line) {
              ...
              var locationBits = [options.styles.location(line.location), options.styles.line(line.line)];
          ...
          scope.clean = clean;
          scope.pretty = pretty;
        })(typeof module !== 'undefined' ? module.exports : (this || _global).Stacky = (this || _global).Stacky || {});
      }, {
        "./parsing": 4,
        "chalk": undefined
      }],

...
export function dew() {
  ...
  (function () {
    var r, t, n, e, i, o, a, s;
    t = {}, s = this || _global, null !== module && module.exports ? module.exports = t : s.ipaddr = t, a = function (r, t, n, e) {
      var i, o;
      ...
      return r.prototype.kind = function () {
        ...
        return a((this || _global).octets, r.octets, 8, t);
        ...
        return t.subnetMatch(this || _global, (this || _global).SpecialRanges);
        ...
        for (a = {
          ...
          if (!((e = (this || _global).octets[t]) in a)) return null;
      ...
      function r(r, t) {
        var n, e, i, o, a, s;
        if (16 === r.length) for ((this || _global).parts = [], n = e = 0; e <= 14; n = e += 2) (this || _global).parts.push(r[n] << 8 | r[n + 1]);else {
          if (8 !== r.length) throw new Error("ipaddr: ipv6 part count should be 8 or 16");
          (this || _global).parts = r;
        }

        for (i = 0, o = (s = (this || _global).parts).length; i < o; i++) if (!(0 <= (a = s[i]) && a <= 65535)) throw new Error("ipaddr: ipv6 part should fit in 16 bits");

        t && ((this || _global).zoneId = t);
      }
      ...
      return r.prototype.kind = function () {
        ...
        for (r = [], t = 0, n = (i = (this || _global).parts).length; t < n; t++) e = i[t], r.push(e >> 8), r.push(255 & e);
        ...
        return r = function () {
          ...
          for (i = [], r = 0, n = (e = (this || _global).parts).length; r < n; r++) t = e[r], i.push(t.toString(16));

          return i;
        }.call(this || _global).join(":"), n = "", (this || _global).zoneId && (n = "%" + (this || _global).zoneId), r + n;
      }, r.prototype.toFixedLengthString = function () {
        var r, t, n;
        return r = function () {
          var r, n, e, i;

          for (i = [], r = 0, n = (e = (this || _global).parts).length; r < n; r++) t = e[r], i.push(t.toString(16).padStart(4, "0"));
        ...
        return a((this || _global).parts, r.parts, 16, t);
      }, r.prototype.SpecialRanges = {
        ...
        return e = (this || _global).parts.slice(-2), r = e[0], n = e[1], new t.IPv4([r >> 8, 255 & r, n >> 8, 255 & n]);
      }, r.prototype.prefixLengthFromSubnetMask = function () {
        var r, t, n, e, i, o, a;
        ...
        for (a = {
          ...
          if (!((e = (this || _global).parts[t]) in a)) return null;
          if (o = a[e], i && 0 !== o) return null;
          16 !== o && (i = !0), r += o;
        }
      ...
      try {
        return new (this || _global)(this.parser(r)), !0;
      } catch (r) {
        return r, !1;
      }
      ...
      try {
        return t = this.parser(r), new (this || _global)(t.parts, t.zoneId), !0;
      } catch (r) {
        return r, !1;
      }
      ...
      return t < 4 && (e[t] = Math.pow(2, r % 8) - 1 << 8 - r % 8), new (this || _global)(e);

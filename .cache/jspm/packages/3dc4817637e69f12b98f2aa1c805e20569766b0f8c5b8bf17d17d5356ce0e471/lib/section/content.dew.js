import { dew as _sectionDewDew } from "../section.dew.js";
import { dew as _indexDewDew } from "typical/index.dew.js";
import { dew as _indexDew2Dew } from "table-layout/index.dew.js";
import { dew as _chalkFormatDewDew } from "../chalk-format.dew.js";
import { dew as _indexDew3Dew } from "array-back/index.dew.js";
var exports = {},
    _dewExec = false;
...
export function dew() {
  ...
  const Section = _sectionDewDew();

  const t = _indexDewDew();

  const Table = _indexDew2Dew();

  const chalkFormat = _chalkFormatDewDew();

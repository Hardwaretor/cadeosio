...
import { dew as _indexDewDew } from "table-layout/index.dew.js";
import { dew as _chalkFormatDewDew } from "../chalk-format.dew.js";
import { dew as _indexDew2Dew } from "typical/index.dew.js";
...
export function dew() {
  ...
  const Table = _indexDewDew();

  const chalk = _chalkFormatDewDew();

  const t = _indexDew2Dew();

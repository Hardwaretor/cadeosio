import { dew as _indexDewDew } from "babel-helper-evaluate-path/index.dew.js";
import { dew as _replacementsDewDew } from "./replacements.dew.js";
var exports = {},
    _dewExec = false;
export function dew() {
  ...
  const evaluate = _indexDewDew();

  const _require = _replacementsDewDew(),
  ...
  exports = babel => {
    const replacements = _replacementsDewDew()(babel);

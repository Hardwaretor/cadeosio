import { dew as _sourceMapGeneratorDewDew } from "./source-map-generator.dew.js";
...
export function dew() {
   ...
   */
  var SourceMapGenerator = _sourceMapGeneratorDewDew().SourceMapGenerator;

  var util = _utilDewDew(); // Matches a Windows-style `\r\n` newline or a `\n` newline used by all other

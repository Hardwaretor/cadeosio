...
import { dew as _regexesDewDew } from "./lib/regexes.dew.js";
import { dew as _mappingTableJsonDewDew } from "./lib/mappingTable.json.dew.js";
var exports = {},
    _dewExec = false;
export function dew() {
  if (_dewExec) return exports;
  _dewExec = true;
  const punycode = _punycode;

  const regexes = _regexesDewDew();

  const mappingTable = _mappingTableJsonDewDew();

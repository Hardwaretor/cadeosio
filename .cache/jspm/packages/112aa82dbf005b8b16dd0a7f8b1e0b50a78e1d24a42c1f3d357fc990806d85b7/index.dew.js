import { dew as _indexDewDew } from "camelcase/index.dew.js";
import _path from "path";
import { dew as _tokenizeArgStringDewDew } from "./lib/tokenize-arg-string.dew.js";
...
export function dew() {
  ...
  var tokenizeArgString = _tokenizeArgStringDewDew();

  var util = _util;

  var assign = _indexDew2Dew();

  function parse(args, opts) {
    if (!opts) opts = Object.create(null); // allow a string argument to be passed in rather
    // than an argv array.
    ...
    var newAliases = Object.create(null); // allow a i18n handler to be passed in, default to a fake one (util.format).
        ...
        if (configPath) {
          try {
            ...
            if (typeof flags.configs[configKey] === 'function') {
              ...
              config = _nodeRequire(resolvedConfigPath);
            }
  ...
  function combineAliases(aliases) {
    var aliasArrays = [];
    var change = true;
    var combined = Object.create(null); // turn alias lookup hash {key: ['alias1', 'alias2']} into

...
import { dew as _indexDew2Dew } from "http-proxy/index.dew.js";
import { dew as _configFactoryDewDew } from "./config-factory.dew.js";
import { dew as _handlersDewDew } from "./handlers.dew.js";
import { dew as _contextMatcherDewDew } from "./context-matcher.dew.js";
import { dew as _pathRewriterDewDew } from "./path-rewriter.dew.js";
import { dew as _routerDewDew } from "./router.dew.js";
...
export function dew() {
  ...
  var httpProxy = _indexDew2Dew();

  var configFactory = _configFactoryDewDew();

  var handlers = _handlersDewDew();

  var contextMatcher = _contextMatcherDewDew();

  var PathRewriter = _pathRewriterDewDew();

  var Router = _routerDewDew();

  var logger = _loggerDewDew().getInstance();

  var getArrow = _loggerDewDew().getArrow;

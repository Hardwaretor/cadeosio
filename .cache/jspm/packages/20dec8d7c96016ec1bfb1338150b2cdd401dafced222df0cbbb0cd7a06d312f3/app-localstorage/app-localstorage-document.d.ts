 ...
 *   app-localstorage/app-localstorage-document.js
 */
 ...
 */
interface AppLocalstorageDocumentElement extends AppStorageBehavior, LegacyElementMixin, HTMLElement {
  readonly isNew: any;
...
export {AppLocalstorageDocumentElement};

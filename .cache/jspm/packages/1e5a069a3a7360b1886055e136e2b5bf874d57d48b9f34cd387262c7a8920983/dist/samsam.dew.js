...
export function dew() {
  ...
  (function (global, factory) {
    typeof exports === 'object' && true ? factory(exports, _indexDewDew(), _indexDew2Dew()) : typeof define === 'function' && define.amd ? define(['exports', '@sinonjs/commons', 'lodash'], factory) : factory(global.samsam = {}, global.require$$0, global.lodash);
  })(exports, function (exports, require$$0, lodash) {
    'use strict';
    ...
    function isArguments(object) {
      ...
      if (typeof object !== "object" || typeof object.length !== "number" || getClass_1(object) === "Array") {
        return false;
      }
    ...
    var isMap_1 = isMap; // Returns true when the value is a regular Object and not a specialized Object
    //
    ...
    function deepEqualCyclic(actual, expectation, match) {
      ...
      return function deepEqual(actualObj, expectationObj, actualPath, expectationPath) {
        ...
        if (isSet_1(actualObj) || isSet_1(expectationObj)) {
          if (!isSet_1(actualObj) || !isSet_1(expectationObj) || actualObj.size !== expectationObj.size) {
            return false;
          }
        ...
        if (isMap_1(actualObj) || isMap_1(expectationObj)) {
          if (!isMap_1(actualObj) || !isMap_1(expectationObj) || actualObj.size !== expectationObj.size) {
            return false;
          }
        ...
        return every(expectationKeysAndSymbols, function (key) {
          ...
          var expectationObject = isObject_1(expectationValue); // determines, if the objects were already visited
    ...
    match.every = function (predicate) {
      ...
      return match(function (actual) {
        ...
        return isIterable(actual) && every$1(actual, function (element) {
    ...
    match.array.deepEquals = function (expectation) {
      return match(function (actual) {
        ...
        return typeOf$1(actual) === "array" && sameLength && every$1(actual, function (element, index) {
          var expected = expectation[index];
          return typeOf$1(expected) === "array" && typeOf$1(element) === "array" ? match.array.deepEquals(expected).test(element) : deepEqual$1(expected, element);
        });
    ...
    match.array.startsWith = function (expectation) {
      return match(function (actual) {
        return typeOf$1(actual) === "array" && every$1(expectation, function (expectedElement, index) {
    ...
    match.array.contains = function (expectation) {
      return match(function (actual) {
        return typeOf$1(actual) === "array" && every$1(expectation, function (expectedElement) {
    ...
    match.map.deepEquals = function mapDeepEquals(expectation) {
      return match(function (actual) {
        ...
        return typeOf$1(actual) === "map" && sameLength && every$1(actual, function (element, key) {
    ...
    match.map.contains = function mapContains(expectation) {
      return match(function (actual) {
        return typeOf$1(actual) === "map" && every$1(expectation, function (element, key) {
    ...
    match.set.deepEquals = function setDeepEquals(expectation) {
      return match(function (actual) {
        // Comparing lengths is the fastest way to spot a difference before iterating through every item
        var sameLength = actual.size === expectation.size;
        return typeOf$1(actual) === "set" && sameLength && every$1(actual, function (element) {
    ...
    match.set.contains = function setContains(expectation) {
      return match(function (actual) {
        return typeOf$1(actual) === "set" && every$1(expectation, function (element) {
    ...
    function match$1(object, matcher) {
      ...
      if (typeof matcher === "string") {
        ...
        return notNull && valueToString$3(object).toLowerCase().indexOf(matcher) >= 0;
      }
      ...
      if (matcher && typeof matcher === "object") {
        ...
        for (prop in matcher) {
          ...
          } else if (typeof value === "undefined" || !deepEqual$2(value, matcher[prop])) {
            return false;
          }
        }

...
import { dew as _escapeDewDew } from "./util/escape.dew.js";
...
export function dew() {
  ...
  const resolveCommand = _resolveCommandDewDew();

  const escape = _escapeDewDew();

  const readShebang = _readShebangDewDew();

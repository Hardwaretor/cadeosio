  ...
  (function (f) {
    ...
    return function () {
      function r(e, n, t) {
        ...
        for (var u = _nodeRequire, i = 0; i < t.length; i++) o(t[i]);
      ...
      3: [function (require, module, exports) {
        ...
        module.exports = function (_chai, util) {
          ...
          function Assertion(obj, msg, ssfi, lockSsfi) {
            flag(this || _global, 'ssfi', ssfi || Assertion);
            flag(this || _global, 'lockSsfi', lockSsfi);
            flag(this || _global, 'object', obj);
            flag(this || _global, 'message', msg);
            return util.proxify(this || _global);
          }
          ...
          Assertion.addProperty = function (name, fn) {
            util.addProperty((this || _global).prototype, name, fn);
          };

          Assertion.addMethod = function (name, fn) {
            util.addMethod((this || _global).prototype, name, fn);
          };

          Assertion.addChainableMethod = function (name, fn, chainingBehavior) {
            util.addChainableMethod((this || _global).prototype, name, fn, chainingBehavior);
          };

          Assertion.overwriteProperty = function (name, fn) {
            util.overwriteProperty((this || _global).prototype, name, fn);
          };

          Assertion.overwriteMethod = function (name, fn) {
            util.overwriteMethod((this || _global).prototype, name, fn);
          };

          Assertion.overwriteChainableMethod = function (name, fn, chainingBehavior) {
            util.overwriteChainableMethod((this || _global).prototype, name, fn, chainingBehavior);
          };
          /**
          ...
          Assertion.prototype.assert = function (expr, msg, negateMsg, expected, _actual, showDiff) {
            var ok = util.test(this || _global, arguments);
            if (false !== showDiff) showDiff = true;
            if (undefined === expected && undefined === _actual) showDiff = false;
            if (true !== config.showDiff) showDiff = false;

            if (!ok) {
              msg = util.getMessage(this || _global, arguments);
              var actual = util.getActual(this || _global, arguments);
              throw new AssertionError(msg, {
                actual: actual,
                expected: expected,
                showDiff: showDiff
              }, config.includeStack ? (this || _global).assert : flag(this || _global, 'ssfi'));
            }
          };
          /*!
           * ### ._obj
          ...
          Object.defineProperty(Assertion.prototype, '_obj', {
            get: function () {
              return flag(this || _global, 'object');
            },
            set: function (val) {
              flag(this || _global, 'object', val);
            }
          });
        };
      }, {
      ...
      5: [function (require, module, exports) {
        ...
        module.exports = function (chai, _) {
          ...
          Assertion.addProperty('ordered', function () {
            flag(this || _global, 'ordered', true);
          });
          /**
           * ### .any
           *
          ...
          Assertion.addProperty('any', function () {
            flag(this || _global, 'any', true);
            flag(this || _global, 'all', false);
          });
          /**
           * ### .all
           *
          ...
          Assertion.addProperty('all', function () {
            flag(this || _global, 'all', true);
            flag(this || _global, 'any', false);
          });
          /**
           * ### .a(type[, msg])
           *
          ...
          function an(type, msg) {
            if (msg) flag(this || _global, 'message', msg);
            type = type.toLowerCase();
            var obj = flag(this || _global, 'object'),
          ...
          function includeChainingBehavior() {
            flag(this || _global, 'contains', true);
          }
          ...
          function include(val, msg) {
            ...
            var obj = flag(this || _global, 'object'),
                ...
                flagMsg = flag(this || _global, 'message'),
                negate = flag(this || _global, 'negate'),
                ssfi = flag(this || _global, 'ssfi'),
                isDeep = flag(this || _global, 'deep'),
            ...
            switch (objType) {
              ...
              default:
                ...
                props.forEach(function (prop) {
                  ...
                  _.transferFlags(this || _global, propAssertion, true);
                ...
                }, this || _global); // When validating .not.include with multiple properties, we only want
          ...
          Assertion.addProperty('ok', function () {
            this.assert(flag(this || _global, 'object'), 'expected #{this} to be truthy', 'expected #{this} to be falsy');
          });
          /**
           * ### .true
           *
          ...
          Assertion.addProperty('true', function () {
            this.assert(true === flag(this || _global, 'object'), 'expected #{this} to be true', 'expected #{this} to be false', flag(this || _global, 'negate') ? false : true);
          });
          /**
           * ### .false
           *
          ...
          Assertion.addProperty('false', function () {
            this.assert(false === flag(this || _global, 'object'), 'expected #{this} to be false', 'expected #{this} to be true', flag(this || _global, 'negate') ? true : false);
          });
          /**
           * ### .null
           *
          ...
          Assertion.addProperty('null', function () {
            this.assert(null === flag(this || _global, 'object'), 'expected #{this} to be null', 'expected #{this} not to be null');
          });
          /**
           * ### .undefined
           *
          ...
          Assertion.addProperty('undefined', function () {
            this.assert(undefined === flag(this || _global, 'object'), 'expected #{this} to be undefined', 'expected #{this} not to be undefined');
          });
          /**
           * ### .NaN
           *
          ...
          Assertion.addProperty('NaN', function () {
            this.assert(_.isNaN(flag(this || _global, 'object')), 'expected #{this} to be NaN', 'expected #{this} not to be NaN');
          });
          /**
           * ### .exist
           *
          ...
          Assertion.addProperty('exist', function () {
            var val = flag(this || _global, 'object');
          ...
          function assertEqual(val, msg) {
            ...
            if (flag(this || _global, 'deep')) {
              var prevLockSsfi = flag(this || _global, 'lockSsfi');
              flag(this || _global, 'lockSsfi', true);
              this.eql(val);
              flag(this || _global, 'lockSsfi', prevLockSsfi);
            } else {
              this.assert(val === obj, 'expected #{this} to equal #{exp}', 'expected #{this} to not equal #{exp}', val, (this || _global)._obj, true);
            }
          }
          ...
          function assertEql(obj, msg) {
            if (msg) flag(this || _global, 'message', msg);
            this.assert(_.eql(obj, flag(this || _global, 'object')), 'expected #{this} to deeply equal #{exp}', 'expected #{this} to not deeply equal #{exp}', obj, (this || _global)._obj, true);
          }
          ...
          function assertAbove(n, msg) {
            ...
            var obj = flag(this || _global, 'object'),
                doLength = flag(this || _global, 'doLength'),
                flagMsg = flag(this || _global, 'message'),
          ...
          function assertInstanceOf(constructor, msg) {
            if (msg) flag(this || _global, 'message', msg);
            var target = flag(this || _global, 'object');
            var ssfi = flag(this || _global, 'ssfi');
            var flagMsg = flag(this || _global, 'message');
          ...
          function assertProperty(name, val, msg) {
            if (msg) flag(this || _global, 'message', msg);
            var isNested = flag(this || _global, 'nested'),
                isOwn = flag(this || _global, 'own'),
                flagMsg = flag(this || _global, 'message'),
                obj = flag(this || _global, 'object'),
                ssfi = flag(this || _global, 'ssfi'),
            ...
            var isDeep = flag(this || _global, 'deep'),
                negate = flag(this || _global, 'negate'),
            ...
            flag(this || _global, 'object', value);
          }
          ...
          function assertOwnProperty(name, value, msg) {
            flag(this || _global, 'own', true);
            assertProperty.apply(this || _global, arguments);
          }
          ...
          function assertOwnPropertyDescriptor(name, descriptor, msg) {
            ...
            flag(this || _global, 'object', actualDescriptor);
          }
          ...
          function assertLengthChain() {
            flag(this || _global, 'doLength', true);
          }
          ...
          function assertKeys(keys) {
            ...
            var len = keys.length,
                any = flag(this || _global, 'any'),
                all = flag(this || _global, 'all'),
                expected = keys;
            ...
            str = (flag(this || _global, 'contains') ? 'contain ' : 'have ') + str; // Assertion
          ...
          function assertThrows(errorLike, errMsgMatcher, msg) {
            ...
            var obj = flag(this || _global, 'object'),
                ssfi = flag(this || _global, 'ssfi'),
                flagMsg = flag(this || _global, 'message'),
                negate = flag(this || _global, 'negate') || false;
            ...
            flag(this || _global, 'object', caughtErr);
          }
          ...
          function respondTo(method, msg) {
            if (msg) flag(this || _global, 'message', msg);
            var obj = flag(this || _global, 'object'),
                itself = flag(this || _global, 'itself'),
          ...
          function satisfy(matcher, msg) {
            ...
            this.assert(result, 'expected #{this} to satisfy ' + _.objDisplay(matcher), 'expected #{this} to not satisfy' + _.objDisplay(matcher), flag(this || _global, 'negate') ? false : true, result);
          }
          ...
          Assertion.addMethod('members', function (subset, msg) {
            ...
            var contains = flag(this || _global, 'contains');
            var ordered = flag(this || _global, 'ordered');
            ...
            var cmp = flag(this || _global, 'deep') ? _.eql : undefined;
          ...
          function oneOf(list, msg) {
            if (msg) flag(this || _global, 'message', msg);
            var expected = flag(this || _global, 'object'),
                flagMsg = flag(this || _global, 'message'),
                ssfi = flag(this || _global, 'ssfi');
          ...
          function assertChanges(subject, prop, msg) {
            if (msg) flag(this || _global, 'message', msg);
            var fn = flag(this || _global, 'object'),
                flagMsg = flag(this || _global, 'message'),
                ssfi = flag(this || _global, 'ssfi');
            ...
            flag(this || _global, 'deltaMsgObj', msgObj);
            flag(this || _global, 'initialDeltaValue', initial);
            flag(this || _global, 'finalDeltaValue', final);
            flag(this || _global, 'deltaBehavior', 'change');
            flag(this || _global, 'realDelta', final !== initial);
          ...
          function assertIncreases(subject, prop, msg) {
            ...
            flag(this || _global, 'initialDeltaValue', initial);
            flag(this || _global, 'finalDeltaValue', final);
            flag(this || _global, 'deltaBehavior', 'increase');
            flag(this || _global, 'realDelta', final - initial);
          ...
          function assertDecreases(subject, prop, msg) {
            ...
            flag(this || _global, 'initialDeltaValue', initial);
            flag(this || _global, 'finalDeltaValue', final);
            flag(this || _global, 'deltaBehavior', 'decrease');
            flag(this || _global, 'realDelta', initial - final);
          ...
          function assertDelta(delta, msg) {
            if (msg) flag(this || _global, 'message', msg);
            var msgObj = flag(this || _global, 'deltaMsgObj');
            var initial = flag(this || _global, 'initialDeltaValue');
            var final = flag(this || _global, 'finalDeltaValue');
            var behavior = flag(this || _global, 'deltaBehavior');
            var realDelta = flag(this || _global, 'realDelta');
            var expression;
          ...
          Assertion.addProperty('extensible', function () {
            var obj = flag(this || _global, 'object'); // In ES5, if the argument to this method is a primitive, then it will cause a TypeError.
        ...
        module.exports = function (chai, util) {
          ...
          function loadShould() {
            ...
            function shouldGetter() {
              if ((this || _global) instanceof String || (this || _global) instanceof Number || (this || _global) instanceof Boolean || typeof Symbol === 'function' && (this || _global) instanceof Symbol) {
                return new Assertion(this.valueOf(), null, shouldGetter);
              }

              return new Assertion(this || _global, null, shouldGetter);
            }
            ...
            function shouldSetter(value) {
              ...
              Object.defineProperty(this || _global, 'should', {
                value: value,
                enumerable: true,
                configurable: true,
                writable: true
        ...
        module.exports = function addChainableMethod(ctx, name, method, chainingBehavior) {
          ...
          Object.defineProperty(ctx, name, {
            get: function chainableMethodGetter() {
              chainableBehavior.chainingBehavior.call(this || _global);
              ...
              var chainableMethodWrapper = function () {
                ...
                if (!flag(this || _global, 'lockSsfi')) {
                  flag(this || _global, 'ssfi', chainableMethodWrapper);
                }

                var result = chainableBehavior.method.apply(this || _global, arguments);
              ...
              if (canSetPrototype) {
                ...
                var prototype = Object.create(this || _global); // Restore the `call` and `apply` methods from `Function`
              ...
              transferFlags(this || _global, chainableMethodWrapper);
      ...
      27: [function (require, module, exports) {
        ...
        module.exports = function overwriteChainableMethod(ctx, name, method, chainingBehavior) {
          ...
          chainableBehavior.chainingBehavior = function overwritingChainableMethodGetter() {
            var result = chainingBehavior(_chainingBehavior).call(this || _global);
          ...
          chainableBehavior.method = function overwritingChainableMethodWrapper() {
            var result = method(_method).apply(this || _global, arguments);
        ...
        module.exports = function overwriteProperty(ctx, name, getter) {
          ...
          Object.defineProperty(ctx, name, {
            get: function overwritingPropertyGetter() {
              ...
              // set by the proxy getter.
              if (!isProxyEnabled() && !flag(this || _global, 'lockSsfi')) {
                flag(this || _global, 'ssfi', overwritingPropertyGetter);
              ...
              var origLockSsfi = flag(this || _global, 'lockSsfi');
              flag(this || _global, 'lockSsfi', true);
              var result = getter(_super).call(this || _global);
              flag(this || _global, 'lockSsfi', origLockSsfi);
      ...
      33: [function (require, module, exports) {
        ...
        function AssertionError(message, _props, ssf) {
          ...
          (this || _global).message = message || 'Unspecified AssertionError';
          (this || _global).showDiff = false; // copy from properties

          for (var key in props) {
            (this || _global)[key] = props[key];
          } // capture stack trace
          ...
          if (Error.captureStackTrace) {
            Error.captureStackTrace(this || _global, ssf);
          } else {
            try {
              throw new Error();
            } catch (e) {
              (this || _global).stack = e.stack;
            }
          }
        }
        /*!
        ...
        AssertionError.prototype.toJSON = function (stack) {
          ...
          }, this || _global); // include stack if exists and not turned off

          if (false !== stack && (this || _global).stack) {
            props.stack = (this || _global).stack;
          }
      ...
      35: [function (require, module, exports) {
        ...
        function FakeMap() {
          (this || _global)._key = 'chai/deep-eql__' + Math.random() + Date.now();
        }

        FakeMap.prototype = {
          get: function getMap(key) {
            return key[(this || _global)._key];
          },
          set: function setMap(key, value) {
            if (Object.isExtensible(key)) {
              Object.defineProperty(key, (this || _global)._key, {
                value: value,
                configurable: true
              });
            }
      ...
      38: [function (require, module, exports) {
        (function (global, factory) {
          ...
          var globalObject = typeof self === 'object' ? self : _global; // eslint-disable-line id-blacklist

import { dew as _indexDewDew } from "got/index.dew.js";
import { dew as _indexDew2Dew } from "is-plain-obj/index.dew.js";
...
export function dew() {
  ...
  const got = _indexDewDew();

  const isPlainObj = _indexDew2Dew();
  ...
  for (const x of helpers) {
    ...
    ghGot[x] = (url, opts) => ghGot(url, Object.assign({}, opts, {
      method
    }));

    ghGot.stream[x] = (url, opts) => ghGot.stream(url, Object.assign({}, opts, {
      method
    }));
  }

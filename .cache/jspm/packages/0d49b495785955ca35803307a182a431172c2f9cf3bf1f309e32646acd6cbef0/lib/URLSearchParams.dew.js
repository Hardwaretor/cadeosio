import { dew as _indexDewDew } from "webidl-conversions/index.dew.js";
import { dew as _utilsDewDew } from "./utils.dew.js";
import { dew as _URLSearchParamsImplDewDew } from "./URLSearchParams-impl.dew.js";
var exports = {},
    _dewExec = false;
export function dew() {
  ...
  const conversions = _indexDewDew();
  ...
  const iface = {
    ...
    is(obj) {
      if (obj) {
        ...
        for (let i = 0; i < exports.mixedInto.length; ++i) {
          if (obj instanceof exports.mixedInto[i]) {
            return true;
          }
        }
      }
    ...
    isImpl(obj) {
      if (obj) {
        ...
        for (let i = 0; i < exports.mixedInto.length; ++i) {
          if (wrapper instanceof exports.mixedInto[i]) {
            return true;
          }
        }
      }
  ...
  const Impl = _URLSearchParamsImplDewDew();

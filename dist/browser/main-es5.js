(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var routes = [
                ...
                },
                {
                    ...
                    loadChildren: function () { return __webpack_require__.e(/*! import() */ 4).then(__webpack_require__.bind(null, /*! ./getting-started/getting-started.module */ "./src/app/getting-started/getting-started.module.ts")).then(function (m) { return m.GettingStartedModule; }); }
                },
                {
                    path: 'features',
                    loadChildren: function () { return __webpack_require__.e(/*! import() */ 3).then(__webpack_require__.bind(null, /*! ./features/features.module */ "./src/app/features/features.module.ts")).then(function (m) { return m.FeaturesModule; }); }
                },
                {
                    path: 'i18n',
                    loadChildren: function () { return __webpack_require__.e(/*! import() */ 5).then(__webpack_require__.bind(null, /*! ./i18n/i18n.module */ "./src/app/i18n/i18n.module.ts")).then(function (m) { return m.I18nModule; }); }
                },
                {
                    path: 'legal',
                ...
                {
                    path: 'wallet',
                    loadChildren: function () { return Promise.resolve( /*! import() */).then(__webpack_require__.bind(null, /*! ./wallet/wallet.module */ "./src/app/wallet/wallet.module.ts")).then(function (m) { return m.WalletModule; }); },
                },
                {
                    path: 'secured',
                    loadChildren: function () { return __webpack_require__.e(/*! import() */ 0).then(__webpack_require__.bind(null, /*! ./faq/faq.module */ "./src/app/faq/faq.module.ts")).then(function (m) { return m.FaqModule; }); },
                ...
                { path: 'user-list', loadChildren: function () { return __webpack_require__.e(/*! import() */ 2).then(__webpack_require__.bind(null, /*! ./campus/campus.module */ "./src/app/campus/campus.module.ts")).then(function (m) { return m.CampusModule; }); } },
                { path: 'user-list', loadChildren: function () { return __webpack_require__.e(/*! import() */ 6).then(__webpack_require__.bind(null, /*! ./plm/plm.module */ "./src/app/plm/plm.module.ts")).then(function (m) { return m.PlmModule; }); } }
            ];
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Cadeosio3dComponent = /** @class */ (function () {
                function Cadeosio3dComponent(titleService, auth, router, snackbar) {
                ...
                Object.defineProperty(Cadeosio3dComponent.prototype, "color", {
                    get: function () {
                ...
                Cadeosio3dComponent.prototype.printUser = function (event) {
                    console.log('onSuccess event ->', event);
                    this.error = false;
                    this.index = 2;
                };
                Cadeosio3dComponent.prototype.printError = function (event) {
                    console.error('onError event --> ', event);
                    this.error = true;
                    // this.snackbar.open(event.message, 'OK', {duration: 5000});
                };
                Cadeosio3dComponent.prototype.onTabChange = function (event) {
                    console.log('on tab change: ', event);
                };
                Cadeosio3dComponent.prototype.showMessage = function () {
                ...
                Cadeosio3dComponent.prototype.ngOnDestroy = function () {
                    if (this.snackbarSubscription) {
                        this.snackbarSubscription.unsubscribe();
                    }
                };
                Cadeosio3dComponent.prototype.onSignOut = function () {
                    console.log('Sign-out successful!');
                };
                Cadeosio3dComponent.prototype.onAccountDeleted = function () {
                    console.log('Account Delete successful!');
                };
                Cadeosio3dComponent.prototype.createAccount = function () {
                    console.log('create account has beeen requested');
                };
                return Cadeosio3dComponent;
            }());
            Cadeosio3dComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var defaultPrivateKey = '5KQwrPbwdL6PhXujxW37FSSQZ1JiwsST4cqQzDeyXtP79zkvFD3'; // bob
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var WalletComponent = /** @class */ (function () {
                function WalletComponent(titleService, auth, router, snackbar) {
                    this.titleService = titleService;
                    this.auth = auth;
                    this.router = router;
                    this.snackbar = snackbar;
                ...
                Object.defineProperty(WalletComponent.prototype, "color", {
                    get: function () {
                        return this.error ? 'warn' : 'primary';
                    },
                    enumerable: true,
                ...
                WalletComponent.prototype.printUser = function (event) {
                    console.log('onSuccess event ->', event);
                    this.error = false;
                    this.index = 2;
                };
                WalletComponent.prototype.printError = function (event) {
                    console.error('onError event --> ', event);
                    this.error = true;
                    // this.snackbar.open(event.message, 'OK', {duration: 5000});
                };
                WalletComponent.prototype.onTabChange = function (event) {
                    console.log('on tab change: ', event);
                };
                WalletComponent.prototype.showMessage = function () {
                    var _this = this;
                    console.log('on show message');
                    var snackbarReference = this.snackbar.open('onConfirmActionButtonClicked\'s event has been emitted', 'See more examples', {
                        duration: 3000
                ...
                WalletComponent.prototype.onSignOut = function () {
                    console.log('Sign-out successful!');
                };
                WalletComponent.prototype.onAccountDeleted = function () {
                    console.log('Account Delete successful!');
                };
                WalletComponent.prototype.createAccount = function () {
                    console.log('create account has beeen requested');
                };
